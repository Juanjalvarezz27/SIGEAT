...
export default function ListaUsuarios() {
  ...
  const usuarioActualId = session?.user?.id ? parseInt(session.user.id) : null
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full">
            ...
            <div className="p-6">
              <div className="text-center mb-6">
                ...
                {/* Mostrar advertencia especial si es el usuario actual */}
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-xs text-yellow-700">
                          No puedes eliminar tu propia cuenta. Si necesitas hacer cambios, usa la opción "Cambiar contraseña" en tu perfil.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex space-x-3">
                ...
                <button
                  ...
                  disabled={eliminando || usuarioActualId === usuarioAEliminar.id}
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          {/* Botón de eliminar - OCULTAR si es el usuario actual */}
                          {usuarioActualId !== usuario.id && (
                            <button
